...
describe('Authorization policy', () => {
  it('every tool has a policy entry', () => {
    const toolNames = [
      ...
      'get_wallet_balance', 'get_wallet_status', 'add_funds',
      'order_lunch', 'get_orders', 'get_daily_menu', 'get_updates',
      'get_daily_orders', 'get_monthly_orders',
      'get_upcoming_events', 'create_event', 'update_event', 'cancel_event',
      'list_school_restaurants', 'create_restaurant', 'list_menu_items',
      'create_menu_item', 'update_menu_item', 'set_menu_item_price',
      'delete_menu_item', 'set_daily_menu',
    ];
